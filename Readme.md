...
[第一部分：用家操作指南](#_Toc240661194)

[1\. 平台開啟與設定教學](#_Toc240661195)

[1.1 本地電腦使用 (Local Desktop Edition)](#_Toc240661196)

[1.2 互聯網網絡使用 (vtuber.hugow.dev)](#_Toc240661197)

[2\. 用家操作與常見問題故障排除](#_Toc240661198)

[2.1 介面常用功能](#_Toc240661199)

[2.2 常見問題與解決方案](#_Toc240661200)

[第二部分：技術員操作指南](#_Toc240661201)

[1\. Cloudflare Zero Trust (Public Hostnames) 設定教學](#_Toc240661202)

[1.1 了解 Cloudflare Zero Trust 架構優勢](#_Toc240661203)

[1.2 設定 Public Hostnames](#_Toc240661204)

[2\. AI API (利用Ollama localhost)技術文件與 cURL示範](#_Toc240661205)

[第三部分：其他資源](#_Toc240661206)

[1\. Nizima LIVE](#_Toc240661207)

[2\. VTuber Studio](#_Toc240661208)

[3\. OBS Studio (Open Broadcaster Software)](#_Toc240661209)

[第四部分：致謝](#_Toc240661210)
...
- **原因**：背景開啓了多個 Electron
- **解決方法**：按下工作列右下角 ^ (show hidden icon)按鈕，檢查是否有多個 open-llm-vtuber-Electron.exe 在運行。若超過 1 個，請全部關閉，僅保留 1 個後重試。
...
|     |     |     |
| --- | --- | --- |
| 比較項目 | 傳統方法<br><br>(Port Forwarding + DDNS) | Cloudflare Zero Trust<br><br>(Public Hostnames) |
...
1.  **登入 Cloudflare 儀表板**：
    - 前往 Cloudflare Dashboard (dash.cloudflare.com) 並登入帳戶。
2.  **進入 Zero Trust 頁面**：
    - 於左側選單點擊 **Zero Trust**。
3.  **管理現有 Tunnel**：
...
1.  **完成設定**：  
    儲存後，Cloudflare 會自動更新 DNS 紀錄並將外部流量安全地路由至你的本機端口。你現在可以在瀏覽器訪問 https://vtuber.hugow.dev 或呼叫 https://ollama.hugow.dev API。

## 2\. AI API (利用Ollama localhost)技術文件與 cURL示範

ollama.hugow.dev 作為系統的 Ollama網關，提供 RESTful API 以供前端或後端服務進行文本生成與對話互動。

- **Base URL**: https://ollama.hugow.dev (http://localhost:11434)
- **Header**: Content-Type: application/json

詳細文檔：https://github.com/kychugo/vtuber/blob/main/useful%20resources/Ollama.md
